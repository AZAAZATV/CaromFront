    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/login" element={!logined ? <Login url={url} setLogined={setLogined} /> : <Navigate to='/home' replace={true} />} />
          <Route path="/signup" element={!logined ? <Signup url={url} /> : <Navigate to='/home' replace={true} />} />
